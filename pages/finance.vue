    ...
    <div class="detail-container" v-if="showDetail">
      <div class="detail">
       ...
       科系特色區塊 -->
        ...
        <div id="科系特色" class="card1">
          ...
          <p class="description">本著「務實致用、創新精進」之教育方向，培育符合財務金融產業所需之人才。</p>
      ...
      <!-- 發展計畫及未來展望區塊 -->
       <div id="發展計畫及未來展望" class="card2">
        <h3>發展計畫及未來展望</h3>
        <ul>
          <li>培育學生具備<span class="highlight">企業財務決策</span>與<span class="highlight">風險控管</span>之專業能力、培育學生具備證券<span class="highlight">投資理財分析</span>之專業能力、培育學生具備金融機構<span class="highlight">營運管理</span>之專業能力、培育學生具備<span class="highlight">財金資訊科技</span>之基本能力</li>
          <li>以<span class="highlight">「理論與實務並重，縮短學用落差」</span>、<span class="highlight">「深入產業實習，提升產學合作」</span>及<span class="highlight">「強化教師專業，樹立系所特色」</span>為系所發展定位</li>
          <li>透過<span class="highlight">「特色模組課程設計」</span>、<span class="highlight">「致力縮短學用落差」</span>與<span class="highlight">「提升師生研創能力」</span>，形塑本系專業發展特色，培育學生具備財務金融之<span class="highlight">學術及實務</span>能力，並提升本系專業形象。</li>
          <li>配合財務管理、投資學、財務報表分析、期貨與選擇權、衍生性金融商品等課程，開設財金<span class="highlight">證照輔導</span>課程，輔導學生考取相關財金證照。</li>
          <li>培育具有國際觀、創新意識、企業倫理思維、並能深諳財金理論及實務運作與管理，且使用金融資訊從事<span class="highlight">問題分析與決策</span>之財金專業人才</li>
      ...
      <!-- 畢業區塊 -->
        <div id="畢業" class="card3">
          ...
          <div class="job-section">
            ...
            <ul>
              <li>銀行業：體驗銀行櫃檯員職務、基本存提款、轉帳、匯款、理專客戶服務等。</li>
              <li>證券業：體驗證券業務操作、風險控管及客戶服務、財金資訊收集解讀。</li>
              <li>資訊業：體驗電子商務之運作、網站資料建置及客戶資料的建檔管理。</li>
              <li>保險業：體驗保險業務流程、客戶服務與客戶開發、稽核與風險控管。</li>
              <li>服務業：體驗進銷存管理、客戶服務及財務資訊系統客戶服務、應對技巧學習。</li>
            </ul>
...
export default {
  components: {
   ...
   watch: {
    ...
    currentDetail(newValue) {
      if (newValue === '科系特色') {
        this.animateCount('studentCount', 348, 2000); // 動畫持續 2 秒
        this.animateCount('teacherCount', 17, 2000);
        this.animateCount('graduateCount', 94, 2000);
    ...
    return {
      ...
      courses: {
        大一: [
          ...
          { type: '選修', name: '行銷管理', credits: 3 },
          { type: '選修', name: '人際關係', credits: 2 },
          { type: '選修', name: '商用英語會話（一）', credits: 1 },
          { type: '選修', name: '國際行銷', credits: 3 },
          { type: '選修', name: '溝通與談判', credits: 2 },
          { type: '選修', name: '商用英語會話（二）', credits: 1 },
        ...
        大二: [
          ...
          { type: '必修', name: '貨幣銀行學', credits: 3 },
          { type: '必修', name: '個體經濟學', credits: 3 },
          { type: '必修', name: '金融市場與機構', credits: 3 },
          { type: '必修', name: '臺灣開發史', credits: 2 },
          { type: '必修', name: '總體經濟學', credits: 3 },
          { type: '必修', name: '國際金融', credits: 3 },
          { type: '必修', name: '民主憲政與法治', credits: 2 },

          { type: '選修', name: '中級會計學', credits: 3 },
          { type: '選修', name: '辦公室應用軟體', credits: 3 },
          { type: '選修', name: '資料庫概論', credits: 3 },
          { type: '選修', name: '人力資源管理', credits: 3 },
          { type: '選修', name: '財金書報導讀（一）', credits: 2 },
          { type: '選修', name: '商用日語（一）', credits: 1 },
          { type: '選修', name: '商事法', credits: 3 },
          { type: '選修', name: '財金證照輔導（一）', credits: 3 },
          { type: '選修', name: '金融科技概論', credits: 3 },
          { type: '選修', name: '服務業管理', credits: 3 },
          { type: '選修', name: '財金書報導讀（二）', credits: 2 },
          { type: '選修', name: '商用日語（二）', credits: 1 },
        ],
        大三: [
          { type: '必修', name: '財務管理資訊系統', credits: 3 },
          { type: '必修', name: '財務報表分析', credits: 2 },
          { type: '必修', name: '投資學', credits: 3 },
          { type: '必修', name: '期貨與選擇權', credits: 3 },
          { type: '必修', name: '國際財務管理', credits: 2 },
          { type: '必修', name: '財務理論與政策', credits: 3 },
          { type: '必修', name: '財金專題(一)', credits: 3 },
          { type: '必修', name: '應用文與習作', credits: 2 },
          { type: '必修', name: '職涯規劃', credits: 3 },
          { type: '選修', name: '管理會計', credits: 3 },
          { type: '選修', name: '財務數學', credits: 3 },
          { type: '選修', name: '財務規劃與預測', credits: 3 },
          { type: '選修', name: '財務統計分析', credits: 3 },
          { type: '選修', name: '財金證照輔導（二）', credits: 3 },
          { type: '選修', name: '租稅法規', credits: 3 },
          { type: '選修', name: '信託投資與實務', credits: 3 },
          { type: '選修', name: '巨量資料概論', credits: 3 },
          { type: '選修', name: '證券交易', credits: 3 },
          { type: '選修', name: '機器人理財', credits: 3 },
          { type: '選修', name: '審計學', credits: 3 },
          { type: '選修', name: '電子商務', credits: 3 },
          { type: '選修', name: '稅務會計', credits: 3 },
          { type: '選修', name: '國際企業管理', credits: 3 },
          { type: '選修', name: '計量經濟學', credits: 3 },
          { type: '選修', name: '金融法規', credits: 3 },
        ],
        大四: [
          { type: '必修', name: '財金專題(二)', credits: 2 },
          { type: '必修', name: '財金個案分析', credits: 3 },
          { type: '選修', name: '債券市場', credits: 3 },
          { type: '選修', name: '創業投資管理', credits: 3 },
          { type: '選修', name: '基金管理', credits: 3 },
          { type: '選修', name: '國際貿易實務', credits: 3 },
          { type: '選修', name: '財金風險管理', credits: 3 },
          { type: '選修', name: '企業政策', credits: 3 },
          { type: '選修', name: '不動產投資', credits: 3 },
          { type: '選修', name: '程式交易實務', credits: 3 },
          { type: '選修', name: '國際商務外語談判', credits: 3 },
          { type: '選修', name: '財金軟體應用', credits: 3 },
          { type: '選修', name: '衍生性金融商品', credits: 3 },
          { type: '選修', name: '企業重組與購併', credits: 3 },
          { type: '選修', name: '永續金融管理', credits: 3 },
          { type: '選修', name: '企業實習', credits: 3 },
        ],
      },
  ...
  1. 需修習證照相關課程二門(含)以上，且學期成績皆達 80 分(含)以上。<br>
2. 需考取「金融市場常識與職業道德測驗」證照。<br>
3.累計取得和未取得之證照 3 張以上(含)且累計之證照總點數達
40(含)以上。`;
