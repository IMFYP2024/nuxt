    ...
    <div class="detail-container" v-if="showDetail">
      ...
      <!-- 發展計畫及未來展望區塊 -->
       <div id="發展計畫及未來展望" class="card2">
        <h3>發展計畫及未來展望</h3>
        <ul>
          <li>協助學生<span class="highlight">自我定位</span>，以及就業時應選擇之場域，並具備職場上對不同專長人力的需求，故課程規劃中亦列入諸多<span class="highlight">跨領域</span>相關課程。</li>
          <li>各學期均開設外語課程，使學生有持續學習，<span class="highlight">提升外語力</span>的機會，在進修或就業時具<span class="highlight">語文</span>上的優勢。</li>
          <li>鼓勵學生至外系選修本系未開設之<span class="highlight">資訊課程</span>，並<span class="highlight">購置或分享</span>會計、審計、稅務、管理、財金、統計等商管學群領域常用<span class="highlight">軟體與設備</span>，培養具有<span class="highlight">資訊優勢</span>的會計管理專才</li>
          <li>提供各種考照資訊，並開設相關課程<span class="highlight">輔導考照</span>，進而成為考照認證中心，</li>
          <li><span class="highlight">「校外實習」</span>，安排同學至會計師<span class="highlight">事務所</span>、<span class="highlight">國稅局</span>與<span class="highlight">私人企業</span>參與二個月的實習，使學生提早體驗職場，協助本系即將畢業的學生們能夠提早做好就業前的準備，以達成<span class="highlight">「畢業即能就業」</span>的目標。</li>
          <li>營造教師良好的研究條件與環境，鼓勵教師進行<span class="highlight">會計議題</span>、<span class="highlight">會計資訊</span>、<span class="highlight">產學合作</span>及<span class="highlight">會計教育</span>的研究專題，提昇本系的研究風氣與能量。</li>       
        </ul>
      </div>
...
export default {
   ...
   watch: {
    ...
    currentDetail(newValue) {
      if (newValue === '科系特色') {
        ...
        this.animateCount('phdCount', 18, 2000);
      }
    },
  },
  el: '#app',
    ...
    return {
      ...
      courses: {
        ...
        大二: [
          ...
          { type: '必修', name: '稅務法規', credits: 3 },
          { type: '必修', name: '生涯運動', credits: 0 },
          { type: '必修', name: '中級會計', credits: 4 },
          { type: '必修', name: '資料庫系統', credits: 3 },
          { type: '必修', name: '臺灣開發史', credits: 2 },
          { type: '選修', name: '網際網路應用', credits: 3 },
          { type: '選修', name: '金融商品與投資', credits: 3 },
          { type: '選修', name: '商業會計法及記帳法規', credits: 2 },
        ],
        大三: [
          { type: '必修', name: '審計學', credits: 3 },
          { type: '必修', name: '會計資訊系統', credits: 2 },
          { type: '必修', name: '成本與管理會計', credits: 3 },
          { type: '選修', name: '財務與風險管理', credits: 3 },
          { type: '選修', name: '校外實習', credits: 2 },
        ],
        大四: [
          { type: '必修', name: '財務報表分析', credits: 3 },
          { type: '必修', name: '高等會計', credits: 3 },
          { type: '選修', name: '政府會計', credits: 3 },
          { type: '選修', name: '財政學', credits: 3 },
          { type: '選修', name: '資料分析與應用', credits: 3 },
  ...
  必修學分：103<br>
  選修總學分 (含本系/跨系選修)：19<br>
  博雅通識：4領域8學分<br>
  校定語言門檻：中級複試、多益550，或同等級數之英文能力檢定標準<br>
  <span style="color: red;">系定門檻：</span><br>
  證照點數10點<br>
  本系(科)學生如未能於規定期限內通過會計專業能力畢業門檻標準者，應於四技四年級第二學期修習本
系指定替代課程，其成績達 60 分以上者，始得畢業。`;
