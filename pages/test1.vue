  ...
  <div class="page-container">
    <div class="tabs">
      <button
        ...
        :class="{ active: currentTab === tab.type || (currentTab === 'introduce' && activeTab === tab.type) }"
      >
        <i :class="tab.icon"></i>
      </button>
    </div>
  ...
  data() {
    return {
      ...
      tabs: [
        ...
        { name: '商學院', type: 'business', icon: 'fi fi-rr-sack-dollar' },
        { name: '設計學院', type: 'design', icon: 'fi fi-sr-customize-computer' },
...
methods: {
  changeTab(tabType, activeTabType = tabType) {
    console.log("切换到:", tabType, "设置 activeTab 为:", activeTabType);
    ...
    setTimeout(() => {
      ...
      console.log("CurrentTab:", this.currentTab, "ActiveTab:", this.activeTab);
    }, 300);
  }
}
,
